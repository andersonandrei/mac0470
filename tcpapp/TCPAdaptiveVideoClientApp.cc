...
#include "inet/applications/tcpapp/TCPAdaptiveVideoClientApp.h"
...
simsignal_t TCPAdaptiveVideoClientApp::rcvdPkSignal = registerSignal("rcvdPk");
simsignal_t TCPAdaptiveVideoClientApp::sentPkSignal = registerSignal("sentPk");
...
void TCPAdaptiveVideoClientApp::initialize(int stage) {
    TCPAdaptiveVideoClientApp::initialize(stage);
    if (stage != 3)
        return;
...
void TCPAdaptiveVideoClientApp::socketEstablished(int connId, void *ptr) {
    TCPAdaptiveVideoClientApp::socketEstablished(connId, ptr);
...
void TCPAdaptiveVideoClientApp::socketDataArrived(int connId, void *ptr, cPacket *msg, bool urgent) {
    TCPAdaptiveVideoClientApp::socketDataArrived(connId, ptr, msg, urgent);
...
void TCPAdaptiveVideoClientApp::socketClosed(int connId, void *ptr) {
    TCPAdaptiveVideoClientApp::socketClosed(connId, ptr);

    // Nothing to do here...
}

void TCPAdaptiveVideoClientApp::socketFailure(int connId, void *ptr, int code) {
    TCPAdaptiveVideoClientApp::socketFailure(connId, ptr, code);

}

void TCPAdaptiveVideoClientApp::refreshDisplay() const
{
    char buf[64];
